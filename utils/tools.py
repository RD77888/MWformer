...
def parse_ratios(ratio_string):
    """
    Parse a string of comma-separated ratios and return a list of floats.
    Args:
        ratio_string (str): A string of comma-separated ratios.
    Returns:
        list: A list of floats representing the ratios.
    Raises:
